        ...
        >
          ...
          <div className="space-y-6">
            <Card className="border-carp-blue/20 p-2">
              <CardContent className="pt-4">
                <div className="flex items-start mb-4">
                  <div className="p-2 rounded-full bg-carp-blue/10 mr-4">
                    <Calculator className="h-6 w-6 text-carp-blue" />
                  </div>
                  <div>
                    <h3 className="text-lg font-medium mb-1">How We Calculate Fares</h3>
            ...
            <div className="flex items-center space-x-6">
              <div className="flex flex-col items-center text-center">
                ...
                <h4 className="text-sm font-medium">Rider View</h4>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h4 className="text-sm font-medium">Driver View</h4>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h4 className="text-sm font-medium">Fair Pricing</h4>
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-lg border border-gray-100 bg-white">
            <div className="px-5 py-4 border-b border-gray-100 flex items-center">
              ...
              <span className="font-medium">Fare Calculator</span>
            </div>
            
            <div className="p-5">
              <div className="flex items-center justify-between mb-4 pb-4 border-b border-gray-100">
                <div>
                  <p className="text-sm font-medium">University to Downtown</p>
                  <p className="text-xs text-muted-foreground">15 miles, 3 riders</p>
                </div>
                <div className="text-right">
                  <p className="text-sm font-medium text-carp-blue">$5.25</p>
              ...
              <div className="pt-4 border-t border-gray-100">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-bold text-carp-blue">$15.75</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm font-medium">Your Share:</span>
                  <span className="font-bold text-carp-blue">$5.25</span>
                </div>
              </div>
            </div>
          </div>
