      ...
      <main className="pt-32 pb-20 px-6">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="text-center mb-20">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-foreground">Smart Ride Matching</h1>
          ...
          <div className="mb-20">
            <h2 className="text-3xl font-bold mb-10 text-center text-foreground">How It Works</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="glass-effect p-6 rounded-xl scroll-animation border-t-4 border-carp-blue dark:border-blue-500">
                ...
                <h3 className="text-xl font-semibold mb-3 text-foreground">Enter Vehicle Details</h3>
              ...
              <div className="glass-effect p-6 rounded-xl scroll-animation border-t-4 border-carp-blue dark:border-blue-500" style={{ animationDelay: '100ms' }}>
                ...
                <h3 className="text-xl font-semibold mb-3 text-foreground">Set Your Route</h3>
                <p className="text-muted-foreground">
              ...
              <div className="glass-effect p-6 rounded-xl scroll-animation border-t-4 border-carp-blue dark:border-blue-500" style={{ animationDelay: '200ms' }}>
                ...
                <h3 className="text-xl font-semibold mb-3 text-foreground">Intelligent Matching</h3>
                <p className="text-muted-foreground">
          ...
          <div className="mb-20">
            <div className="glass-effect rounded-2xl p-8 md:p-12 border-t-4 border-carp-blue dark:border-blue-500">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                <div>
                  <h2 className="text-3xl font-bold mb-6 text-foreground">Efficiency-First Algorithm</h2>
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-semibold text-foreground">Minimal Detours</h4>
                        <p className="text-muted-foreground">
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-semibold text-foreground">Time-Based Matching</h4>
                        <p className="text-muted-foreground">
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-semibold text-foreground">Vehicle Optimization</h4>
                        <p className="text-muted-foreground">
          ...
          {/* App Preview section */}
          <div className="mb-20">
            <h2 className="text-3xl font-bold mb-10 text-center text-foreground">App Preview</h2>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-center gap-10">
              <div className="relative w-[280px] h-[560px] rounded-[40px] border-[10px] border-black bg-white overflow-hidden shadow-xl dark:bg-gray-800 dark:border-gray-900 mobile-app-preview">
                <div className="relative h-full bg-gradient-to-b from-carp-lightBlue to-white p-4 dark:from-gray-800 dark:to-gray-900 mobile-app-preview-screen">
                  <div className="text-center mb-4">
                    <h3 className="font-semibold text-lg text-foreground">Vehicle Setup</h3>
                  </div>
              ...
              <div className="relative w-[280px] h-[560px] rounded-[40px] border-[10px] border-black bg-white overflow-hidden shadow-xl dark:bg-gray-800 dark:border-gray-900 mobile-app-preview">
                <div className="relative h-full bg-gradient-to-b from-carp-lightBlue to-white p-4 dark:from-gray-800 dark:to-gray-900 mobile-app-preview-screen">
                  <div className="text-center mb-4">
                    <h3 className="font-semibold text-lg text-foreground">Ride Matching</h3>
                  </div>
