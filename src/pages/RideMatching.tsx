      ...
      <main className="pt-32 pb-20 px-6">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="text-center mb-20">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Smart Ride Matching</h1>
          ...
          <div className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="glass-effect p-6 rounded-xl scroll-animation">
              ...
              <div className="glass-effect p-6 rounded-xl scroll-animation" style={{ animationDelay: '100ms' }}>
                <div className="w-12 h-12 bg-carp-lightBlue rounded-lg flex items-center justify-center mb-4">
                  <MapPin className="text-carp-blue" />
                </div>
                <h3 className="text-xl font-semibold mb-3">Set Your Route</h3>
                <p className="text-muted-foreground">
              ...
              <div className="glass-effect p-6 rounded-xl scroll-animation" style={{ animationDelay: '200ms' }}>
                <div className="w-12 h-12 bg-carp-lightBlue rounded-lg flex items-center justify-center mb-4">
          ...
          <div className="mb-20">
            <div className="glass-effect rounded-2xl p-8 md:p-12">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                <div>
                  <h2 className="text-3xl font-bold mb-6">Efficiency-First Algorithm</h2>
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-semibold">Minimal Detours</h4>
                        <p className="text-muted-foreground">
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-semibold">Time-Based Matching</h4>
                        <p className="text-muted-foreground">
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-semibold">Vehicle Optimization</h4>
                        <p className="text-muted-foreground">
          ...
          <div className="mb-20">
            ...
            <div className="flex flex-col lg:flex-row items-center justify-center gap-10">
              <div className="relative w-[280px] h-[560px] rounded-[40px] border-[10px] border-black bg-white overflow-hidden shadow-xl">
                <div className="relative h-full bg-gradient-to-b from-blue-50 to-white p-4">
                  <div className="text-center mb-4">
                    <h3 className="font-semibold text-lg">Vehicle Setup</h3>
                  </div>
                  
                  <div className="space-y-4">
                    <div className="p-3 bg-white rounded-xl shadow-sm">
                      <label className="text-xs text-muted-foreground">Vehicle Make</label>
                      <div className="font-medium">Toyota</div>
                    </div>
                    
                    <div className="p-3 bg-white rounded-xl shadow-sm">
                      <label className="text-xs text-muted-foreground">Vehicle Model</label>
                      <div className="font-medium">Corolla</div>
                    </div>
                    ...
                    <div className="p-3 bg-white rounded-xl shadow-sm">
                      ...
                      <div className="font-medium">32 MPG</div>
                    </div>
              ...
              <div className="relative w-[280px] h-[560px] rounded-[40px] border-[10px] border-black bg-white overflow-hidden shadow-xl">
                <div className="relative h-full bg-gradient-to-b from-blue-50 to-white p-4">
                  <div className="text-center mb-4">
                    <h3 className="font-semibold text-lg">Ride Matching</h3>
                  </div>
                  
                  <div className="space-y-3">
                    <div className="p-3 bg-carp-blue/10 rounded-xl shadow-sm border-l-4 border-carp-blue">
                      <div className="flex justify-between items-center mb-1">
                        <span className="font-medium text-sm">Best Match (98%)</span>
                    ...
                    <div className="p-3 bg-white rounded-xl shadow-sm">
                      <div className="flex justify-between items-center mb-1">
                        <span className="font-medium text-sm">Good Match (85%)</span>
                    ...
                    <div className="p-3 bg-white rounded-xl shadow-sm">
                      <div className="flex justify-between items-center mb-1">
                        <span className="font-medium text-sm">Alternative (72%)</span>
