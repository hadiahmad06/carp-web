        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="text-center mb-20">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-foreground">
              <span className="bg-gradient-to-r from-carp-blue to-blue-500 bg-clip-text text-transparent dark:from-blue-400 dark:to-blue-300">
                Smart Ride Matching
              </span>
            </h1>
          ...
          <div className="mb-20">
            <h2 className="text-3xl font-bold mb-10 text-center text-foreground">
              <span className="text-carp-blue dark:text-blue-300">How It Works</span>
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="glass-effect p-6 rounded-xl scroll-animation border-t-4 border-carp-blue dark:border-blue-500">
                ...
                <h3 className="text-xl font-semibold mb-3 text-foreground">
                  <span className="text-carp-blue dark:text-blue-300">Enter Vehicle Details</span>
                </h3>
              ...
              <div className="glass-effect p-6 rounded-xl scroll-animation border-t-4 border-carp-blue dark:border-blue-500" style={{ animationDelay: '100ms' }}>
                ...
                <h3 className="text-xl font-semibold mb-3 text-foreground">
                  <span className="text-carp-blue dark:text-blue-300">Set Your Route</span>
                </h3>
                <p className="text-muted-foreground">
              ...
              <div className="glass-effect p-6 rounded-xl scroll-animation border-t-4 border-carp-blue dark:border-blue-500" style={{ animationDelay: '200ms' }}>
                ...
                <h3 className="text-xl font-semibold mb-3 text-foreground">
                  <span className="text-carp-blue dark:text-blue-300">Intelligent Matching</span>
                </h3>
                <p className="text-muted-foreground">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                <div>
                  <h2 className="text-3xl font-bold mb-6 text-foreground">
                    <span className="text-carp-blue dark:text-blue-300">Efficiency-First Algorithm</span>
                  </h2>
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-semibold text-foreground">
                          <span className="text-carp-blue dark:text-blue-300">Minimal Detours</span>
                        </h4>
                        <p className="text-muted-foreground">
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-semibold text-foreground">
                          <span className="text-carp-blue dark:text-blue-300">Time-Based Matching</span>
                        </h4>
                        <p className="text-muted-foreground">
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-semibold text-foreground">
                          <span className="text-carp-blue dark:text-blue-300">Vehicle Optimization</span>
                        </h4>
                        <p className="text-muted-foreground">
          ...
          <div className="mb-20">
            <h2 className="text-3xl font-bold mb-10 text-center text-foreground">
              <span className="text-carp-blue dark:text-blue-300">App Preview</span>
            </h2>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-center gap-10">
                ...
                <div className="relative h-full bg-gradient-to-b from-carp-lightBlue to-white p-4 dark:from-gray-800 dark:to-gray-900 mobile-app-preview-screen">
                  <div className="text-center mb-4">
                    <h3 className="font-semibold text-lg text-foreground">
                      <span className="text-carp-blue dark:text-blue-300">Vehicle Setup</span>
                    </h3>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="p-3 bg-white rounded-xl shadow-sm dark:bg-gray-700 mobile-app-input">
                      ...
                      <div className="font-medium text-foreground dark:text-gray-100">Toyota</div>
                    </div>
                    
                    <div className="p-3 bg-white rounded-xl shadow-sm dark:bg-gray-700 mobile-app-input">
                      <label className="text-xs text-muted-foreground">Vehicle Model</label>
                      <div className="font-medium text-foreground dark:text-gray-100">Corolla</div>
                    </div>
                    
                    <div className="p-3 bg-white rounded-xl shadow-sm dark:bg-gray-700 mobile-app-input">
                      <label className="text-xs text-muted-foreground">Year</label>
                      <div className="font-medium text-foreground dark:text-gray-100">2019</div>
                    </div>
                    
                    <div className="p-3 bg-white rounded-xl shadow-sm dark:bg-gray-700 mobile-app-input">
                      <label className="text-xs text-muted-foreground">Fuel Efficiency (MPG)</label>
                      <div className="font-medium text-foreground dark:text-gray-100">32 MPG</div>
                    </div>
                    
                    <div className="p-3 bg-white rounded-xl shadow-sm dark:bg-gray-700 mobile-app-input">
                      <label className="text-xs text-muted-foreground">Passenger Capacity</label>
                      <div className="font-medium text-foreground dark:text-gray-100">4</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="relative w-[280px] h-[560px] rounded-[40px] border-[10px] border-black bg-white overflow-hidden shadow-xl dark:bg-gray-800 dark:border-gray-900 mobile-app-preview">
                <div className="relative h-full bg-gradient-to-b from-carp-lightBlue to-white p-4 dark:from-gray-800 dark:to-gray-900 mobile-app-preview-screen">
                  <div className="text-center mb-4">
                    <h3 className="font-semibold text-lg text-foreground">
                      <span className="text-carp-blue dark:text-blue-300">Ride Matching</span>
                    </h3>
                  </div>
                  ...
                  <div className="space-y-3">
                    <div className="p-3 bg-carp-blue/10 rounded-xl shadow-sm border-l-4 border-carp-blue dark:bg-blue-900/30 dark:border-blue-500">
                      <div className="flex justify-between items-center mb-1">
                        <span className="font-medium text-sm text-foreground dark:text-white">
                          <span className="text-carp-blue dark:text-blue-300">Best Match (98%)</span>
                        </span>
                      ...
                      <div className="flex justify-between text-xs text-foreground dark:text-gray-300">
                    ...
                    <div className="p-3 bg-white rounded-xl shadow-sm dark:bg-gray-700 mobile-app-input">
                      <div className="flex justify-between items-center mb-1">
                        <span className="font-medium text-sm text-foreground dark:text-white">
                          <span className="text-carp-blue dark:text-blue-300">Good Match (85%)</span>
                        </span>
                    ...
                    <div className="p-3 bg-white rounded-xl shadow-sm dark:bg-gray-700 mobile-app-input">
                      <div className="flex justify-between items-center mb-1">
                        <span className="font-medium text-sm text-foreground dark:text-white">
                          <span className="text-carp-blue dark:text-blue-300">Alternative (72%)</span>
                        </span>
